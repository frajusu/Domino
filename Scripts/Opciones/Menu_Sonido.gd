...
func _physics_process(_delta):
	if visible:
		...
		var botones_stats = {
			$Botones.get_node("<_gen") : Global.sonido.gen_vol,
			$Botones.get_node("<_mus") : Global.sonido.mus_vol,
			$Botones.get_node("<_eff") : Global.sonido.eff_vol,
		}
		
		if Global.sonido.gen: $Botones/b_gen/bit.bbcode_text = "[center][wave amp=13 freq=1]On [/wave][/center]" 
		else: $Botones/b_gen/bit.bbcode_text = "[center][wave amp=13 freq=1]Off [/wave][/center]"
		
		if Global.sonido.mus: $Botones/b_mus/bit.bbcode_text = "[center][wave amp=13 freq=1]On [/wave][/center]" 
		else: $Botones/b_mus/bit.bbcode_text = "[center][wave amp=13 freq=1]Off [/wave][/center]"
		
		if Global.sonido.eff: $Botones/b_eff/bit.bbcode_text = "[center][wave amp=13 freq=1]On [/wave][/center]" 
		else: $Botones/b_eff/bit.bbcode_text = "[center][wave amp=13 freq=1]Off [/wave][/center]"
			...
			if dentro:
				...
				if Input.is_action_pressed("click"):
					...
					if botonHover[boton1.name]:
						...
						match boton1.name:
							"<_gen":
								Global.sonido.gen_vol = clamp(Global.sonido.gen_vol - paso, 0.0, 1.0)
							">_gen":
								Global.sonido.gen_vol = clamp(Global.sonido.gen_vol + paso, 0.0, 1.0)
							"<_mus":
								Global.sonido.mus_vol = clamp(Global.sonido.mus_vol - paso, 0.0, 1.0)
							">_mus":
								Global.sonido.mus_vol = clamp(Global.sonido.mus_vol + paso, 0.0, 1.0)
							"<_eff":
								Global.sonido.eff_vol = clamp(Global.sonido.eff_vol - paso, 0.0, 1.0)
							">_eff":
								Global.sonido.eff_vol = clamp(Global.sonido.eff_vol + paso, 0.0, 1.0)
							"b_gen":
								Global.sonido.gen = !Global.sonido.gen
							"b_mus":
								Global.sonido.mus = !Global.sonido.mus
							"b_eff":
								Global.sonido.eff = !Global.sonido.eff
