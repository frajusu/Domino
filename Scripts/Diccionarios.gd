...
var amuletos = {
	...
	"*StampName* Pack" : {"size" : Vector2(32,32),
						   ...
						   "descripcion" : "<#296e8f>Gives 2 Domino normal or special with the *StampName* Stamp.\n<#296e8f>(only <#296e8f>1)",
						   },
	"Overflow Pack" :     {"size" : Vector2(32,32),
						   ...
						   "descripcion" : "<#296e8f>Gives 7 Dominos, but randomly destroys 2 Dominos from your collection.\n<#296e8f>(2)",
						   },
