...
var stamps = {
	...
	"Obsidian Stamp": {
		...
		"descripcion_corta": "2x chances of this color.",
	},
...
var amuletos = {
	...
	"Domino Sticker": {
							...
							"descripcion": "<#296e8f>Allows you to have <#296e8f>+1 <#296e8f>Extra Domino in the <#e0483e>Game <#e0483e>Zone."
	},
	...
	"Combo Trinity" :      {
							...
							"descripcion" : "If all the normal dominos in a single play are <#296e8f>7 or <#296e8f>8, <#296e8f>adds <#e0483e>+3 to the <#e0483e>global <#e0483e>multiplier.", #you get 3 or more patterns/combos 
	},
	...
	"Trickster's Bloom" : {
							...
							"descripcion" : "Each time a <#e0483e>charm activates at the end of a play, there's a <#296e8f>10% chance for it to activate once again.",
	},
