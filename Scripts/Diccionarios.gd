...
var amuletos = {
	...
	"Stamper" : {
							...
							"titulo" : "Stamper",
							"descripcion" : "Allows you to have up to 3 stamps in a single domino.",
	},
	...
	"Rose Bloom" :          {
							...
							"descripcion" : "<#296e8f>50% chance for every Rose dominos that scores to <#296e8f>gain <#296e8f>+0.2 color multiplier (max <#e0483e>x2). \n<#296e8f>(now <#296e8f>: <#296e8f>",
	},
	...
	"Final Wish" :          {
							...
							"usable": false,
							"titulo" : "Final Wish",
							"descripcion" : "The last play of the level <#296e8f>adds <#e0483e>+3 to the global multiplier.",
	},
	...
	"Augmented Chance" :  {
							...
							"descripcion" : "Items with chance-based effects get <#e0483e>x2 activation chance. Additional copies increase this multiplier by x1.",
	},
	...
	"Combo Trinity" :      {
							...
							"descripcion" : "If all the normal dominos in a single play are 7 or 8, <#296e8f>adds +3 to the global multiplier.", #you get 3 or more patterns/combos 
	},
	...
	"Chain Dealer" :       {
							...
							"usable": false,
							"titulo" : "Chain Dealer",
							"descripcion" : "<#296e8f>Gain +3 global mult per domino exceeding 7 (8 = <#296e8f>+3, 9 = <#296e8f>+6).", # global multiplier
	},
	...
	"Echo Pattern" :       {
							...
							"plata": "<#b1911a>10",
							"venta": "<#b1911a>10",
							"chance": 300000,  # algo menos común
							"nivel_desbloqueo" : 1,
							"usable": false,
							"titulo" : "Echo Pattern",
	...
	"Gold Seed" :           {
							...
							"descripcion" : "Every <#b1911a>50c owned grants a <#e0483e>2 global multiplier.",
	},
	...
	"Gold Tree" :        {
							...
							"descripcion" : "Every <#b1911a>100c owned grants a <#e0483e>6 global multiplier.",
	},
	...
	"Trickster's Bloom" : {
							...
							"descripcion" : "Each time a charm activates at the end of a play, there's a <#296e8f>10% chance for it to activate up to 2 times.",
	},
	...
	"Crystal Shard" :      {
							...
							"descripcion" : "Each charm activates 2 times, but this takes up 4 slots.", #combo
	},
	...
	"Sun Pendant" :       {
							...
							"usable": false,
							"titulo" : "Sun Pendant",
							"descripcion" : "At level start, for each of the charms owned, <#296e8f>gain <#e0483e>+.5 global multiplier.",
	},
	...
	"Easy Money" :          {
							...
							"usable": false,
							"titulo" : "Easy Money",
							"descripcion" : "Get half the score of the last domino in coins.",
	},
	...
	"Rusty Scale" :       {
							...
							"titulo" : "Rusty Scale",
							"descripcion" : "Gives you get one free charm each shop.",
	},
	...
	"Domino Mask" :       {
							...
							"usable": false,
							"titulo" : "Domino Mask",
							"descripcion" : "Transfomrs into the next charm you buy.", # one away from a combo
	},
	...
	"Crystal Dice" :      {
							...
							"plata": "<#b1911a>10",
							"venta": "<#b1911a>10",
							"chance": 3000000,  # algo menos común
							"nivel_desbloqueo" : 1,
							"usable": false,
							"titulo" : "Crystal Dice",
							"descripcion" : "Mimics one random charm at the start of a level (temporary). \n(",
	},
	...
	"Giant's Tear Drop": {
							...
							"descripcion": "<#e0483e>5% chance of getting all the points in a play as coins."
	},
#	"Gold Bracelet": {
#							"size": Vector2(32, 32),
