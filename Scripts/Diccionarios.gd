...
var stamps = {
	...
	"Ascendant Stamp": {
		...
		"descripcion_corta": "Perma <#296e8f>+2 when it falls.",
	},
	...
	"Amethyst Stamp": {
		...
		"descripcion": "When used, <#296e8f>gives a temporary <#e0483e>x1.2 bonus to the value of all Dominos of the same color during the play.",
		"descripcion_corta": "Same color <#e0483e>x1.2.",
	},
	"Diamond Stamp": {
		"size": Vector2(16, 16),
	...
	"God Stamp": {
		...
		"descripcion": "Each time this Domino is used, it copies the score given from a random special Domino before itself.\n<#296e8f>(null)",
		"descripcion_corta": "Copies Special's score.",
	},
}
...
var amuletos = {
	...
	"*StampName* Pack" : {
							...
							"plata": "<#b1911a>10",
							"venta": "<#b1911a>10",
							"chance": 1000000,  # algo menos común
							"nivel_desbloqueo" : 1,
							"usable": true,
							"tipo_domino" : "stamp",
