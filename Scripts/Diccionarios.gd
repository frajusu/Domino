...
#	},
	...
	"Final Wish" :          {
							...
							"usable": false,
							"titulo" : "Final Wish",
							"descripcion" : "The last play of the level <#296e8f>adds <#e0483e>x2 to the global multiplier.",
	},
	"Augmented Chance" :  {
							"size" : Vector2(32,32),
	...
	"Lucky Break" :        {
							...
							"usable": false,
							"titulo" : "Lucky Break",
							"descripcion" : "<#296e8f>5% chance to replay all dominos after a play.", # without any combos.
	},
	"Stack Overflow" :     {
							"size" : Vector2(32,32),
							...
							"descripcion" : "Destroys dominos in the first play, and adds the amount to global multiplier for the next play.", # Every combo type <#296e8f>adds <#296e8f>+5 to the combo's score
	},
	"Echo Pattern" :       {
							"size" : Vector2(32,32),
	...
	"Gold Medal" :          {
							...
							"descripcion" : "The first 3 dominos of every level has <#e0483e>x1.5 power.", #combo
	},
	...
	"Rusty Scale" :       {
							...
							"usable": false,
							"titulo" : "Rusty Scale",
							"descripcion" : "All coins <#296e8f>gained are taxed −<#296e8f>20%, but charm activations are <#e0483e>x1.5 stronger.",
	},
	"Domino Mask" :       {
							"size" : Vector2(32,32),
