...
var amuletos = {
	...
	"Trickster's Bloom" : {
							...
							"descripcion" : "Each time a charm activates at the end of a play, there's a <#296e8f>10% chance for it to activate twice.",
	},
	...
	"Crystal Shard" :      {
							...
							"descripcion" : "Each charm activates twice, but this takes up 4 slots.", #combo
	},
