...
#			},
	...
	"Blue Fire" :  {
				...
				"descripcion": "Like <#f04015>Fire but <#296e8f>adds 10% of the next dominos instead of +5 points" # ejemplo: "This domino adds <#f3983a>+1"
			},
...
#	},
	...
	"Gold Bracelet": {
							...
							"descripcion": "Adds +1.0 to the global multiplier for every leftover normal? Domino in the play."
	},
}
