...
func musica(a = false):
	var _musica = {
		...
		"Brutal 1" : ["res://assets/SFX/music/brutal1.ogg",  30, 50, 1.0, "mus"],
		"Brutal 2" : ["res://assets/SFX/music/brutal2.ogg",  30, 50, 1.0, "mus"],
		"Brutal 3" : ["res://assets/SFX/music/brutal3.ogg",  30, 50, 1.0, "mus"],
	}
