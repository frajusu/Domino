	...
	match amuleto:
		...
		"Fading Luck":
			...
			if int(amuleto_nodo.valores_diccionario["Fading Luck"][1]) != 0:
				...
				amuleto_nodo.valores_diccionario["Fading Luck"][1] -= 10.0
				amuleto1_nodo.valores_diccionario["Fading Luck"][1] -= 10.0
			else:
				animacion_en_proceso = false
				_intentar_reproducir_siguiente()
				return
		...
		"Domino Surge":
			...
			for i in colores.keys():
				if colores[i] >= 5:
					...
					amuleto_nodo.valores_diccionario["Domino Surge"][i]  += 0.5
					amuleto1_nodo.valores_diccionario["Domino Surge"][i] += 0.5
