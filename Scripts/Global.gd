...
func reproducir_sonido(tipo_sonido: String, posision_del_sonido, mult = 1.0):
	var sonidos = {
		"Hover" : "",
		"Comprar_vender" : ["res://assets/SFX/Coins.ogg", 100, 100, 1, "eff"],
		"cards_shuff" : ["res://assets/SFX/wind.wav", 100, 100, 1, "eff"],
		"laser" : ["res://assets/SFX/laser.wav", 30, 50, 0.7, "eff"],
		"punto" : ["res://assets/SFX/Hollow Punch.wav", 30, 50, 1, "eff"],
		"chips_place_1" : ["res://assets/SFX/chips_place_1.wav", 20, 20, 1, "eff"],
		"chips_place_2" : ["res://assets/SFX/chips_place_2.wav", 20, 20, 1, "eff"],
		"chips_place_3" : ["res://assets/SFX/chips_place_3.wav", 20, 20, 1, "eff"],
		
		"card_fan"  : ["res://assets/SFX/card_fan.wav", 30, 50, 1, "eff"],
		"card_fan1" : ["res://assets/SFX/card_fan1.wav", 30, 50, 1, "eff"],
		
		"punto1" : ["res://assets/SFX/hitHurt.wav", 20, 30, 1, "eff"],
		"punto2" : ["res://assets/SFX/hitHurt.wav", 40, 50, 1.15, "eff"],
...
func musica(a = false):
	var _musica = {
		"brutal" :  ["res://assets/SFX/music/brutal.ogg",   30, 50, 1.0, "mus"],
		"brutal1" : ["res://assets/SFX/music/brutal1.ogg",  30, 50, 1.0, "mus"],
		"brutal2" : ["res://assets/SFX/music/brutal2.ogg",  30, 50, 1.0, "mus"],
		"brutal3" : ["res://assets/SFX/music/brutal3.ogg",  30, 50, 1.0, "mus"],
	}
