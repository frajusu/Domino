...
var stats_base_english = {
	...
	"max_stamps_in_store": "Max stamps in store",
	"draws": "Draws",
	"plays": "Plays",
...
func reproducir_sonido(tipo_sonido: String, posision_del_sonido):
	var sonidos = {
		"Hover" : "",
		"Comprar_vender" : ["res://assets/SFX/Coins.ogg", 100, 100, 1, "Sonidos"],
		"Comprar_vender_1" : ["res://assets/SFX/Coins_1.wav", 20, 30, 1, "Sonidos"],
		"Comprar_vender_2" : ["res://assets/SFX/Hollow Punch.wav", 50, 70, 1, "Sonidos"],
		"Comprar_vender_3" : ["res://assets/SFX/hitHurt.wav", 50, 70, 1, "Sonidos"],
		"Click" : ["res://assets/SFX/Click.wav", 50, 70, 1, "Sonidos"],
		"botones_go" : ["res://assets/SFX/hitHurt.wav", 30, 50, 1.2, "Sonidos"],
		"sonidito_botones" : ["res://assets/SFX/sonidito.wav", 20, 30, 1, "Sonidos"],
		"sonidito_botones1" : ["res://assets/SFX/sonidito.wav", -20, -15, 0.7, "Sonidos"],
		"Denied" : ["res://assets/SFX/Denied.wav",  100, 110, 0.7, "Sonidos"],
		"Boton" : "",
		"Shotgun001": ["res://assets/SFX/armas/disparos/Shotgun003.wav", 4, 6, 1, "Sonidos"],
		"Explosion": ["res://assets/SFX/armas/disparos/Explosion.wav", 4, 6, 1, "Sonidos"],
	}
	...
	if tipo_sonido in sonidos:
		...
		random123.randomize()
		audio_stream.volume_db = convert_percent_to_db(random123.randi_range(sonidos[tipo_sonido][1], sonidos[tipo_sonido][2]))
		audio_stream.bus = sonidos[tipo_sonido][4]  # ← **linea nueva**
	...
	for color in colores.keys():
		...
		for numero in range(1, 9):  # del 1 al 8
			...
			dominos[nombre] = {
				...
				"flechitas" : ["→"],
				"stamps": [  ["God Stamp", Vector2(0, 0)] ], #, ["Ascendant Stamp", Vector2(8, 20)]  ],
				"mult": 1,
				"padre" : 0,
...
func reproducir_suave(player):
	...
	var t = get_tree().create_tween()
	t.tween_property(player, "volume_db", 0, 0.2) # 0.2 segundos de fade in
