...
var usar_color_tienda_en_menus = false
...
func reproducir_sonido(tipo_sonido: String, posision_del_sonido, mult = 1.0):
	var sonidos = {
		...
		"chips_place_1" : ["res://assets/SFX/chips_place_1.wav", 30, 50, 1, "eff"],
		"chips_place_2" : ["res://assets/SFX/chips_place_2.wav", 30, 50, 1, "eff"],
