...
func _physics_process(_delta):
	...
	$Viewport/Zona_de_interfaz.position.x = ((($Viewport/Zona_de_interfaz.position.x-posision.x)/1400000000000))-160
	$Viewport/Zona_de_interfaz.position.y = ((($Viewport/Zona_de_interfaz.position.y-posision.y)/1400000000000))
