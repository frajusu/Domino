...
func invocar_cosas(amuleto):
	...
	match Diccionarios.amuletos[amuleto].tipo_domino:
		"normal":
			...
			$Viewport/Open_charm/tope/seleccion/dominos/NEW.bbcode_text = "[center][wave amp=13 freq=1] Remaining... "+ str(Diccionarios.amuletos[amuleto].cuantos_agarrables) +" [/wave][/center]"
		...
		"stamp":
			...
			$Viewport/Open_charm/tope/seleccion/stamps/NEW.bbcode_text =  "[center][wave amp=13 freq=1] Remaining... "+ str(Diccionarios.amuletos[amuleto].cuantos_agarrables) +" [/wave][/center]"
