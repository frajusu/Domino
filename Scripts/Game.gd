...
func _physics_process(_delta):
	...
	if estacion_actual == "tienda" and !bandera_go_tienda:
		...
		if true:
			...
			var pos = get_global_mouse_position()
			var dentro_x = pos.x > $Viewport/Zona_de_interfaz/Tienda/Zona_de_amuletos/Specials1.global_position.x - diferencia.x - 10 and pos.x < $Viewport/Zona_de_interfaz/Tienda/Zona_de_amuletos/Specials1.global_position.x + diferencia.x +10
			...
			if dentro:
				...
				dentro_y = pos.y > $Viewport/Zona_de_interfaz/Tienda/Zona_de_amuletos/Specials1.global_position.y - diferencia.y and pos.y < $Viewport/Zona_de_interfaz/Tienda/Zona_de_amuletos/Specials1.global_position.y + diferencia.y -10
				dentro = dentro_x and dentro_y
