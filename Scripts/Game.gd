...
func _physics_process(_delta):
	...
	if baraja_activa == "Deck" or baraja_activa == "Deck1":
		if baraja_activa == "Deck":
			$Viewport/Menu_info/Rojo.layout_width = $Viewport/Menu_info/Rojo.contar_dominos_por_color("rojo")*90
			$Viewport/Menu_info/Azul.layout_width = $Viewport/Menu_info/Azul.contar_dominos_por_color("azul")*90
			$Viewport/Menu_info/Verde.layout_width = $Viewport/Menu_info/Verde.contar_dominos_por_color("verde")*90
			$Viewport/Menu_info/Amarillo.layout_width = $Viewport/Menu_info/Amarillo.contar_dominos_por_color("amarillo")*90
