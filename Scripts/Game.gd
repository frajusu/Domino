	...
	if estacion_actual == "nivel":
		...
		if true and bandera_de_menus_movedisos:
			...
			if $Viewport/Zona_de_interfaz/xd/Zona_de_amuletos/Specials1.position.x == 241:
				dentro_x = pos.x > $Viewport/Zona_de_interfaz/xd/Zona_de_amuletos/Specials1.global_position.x - diferencia.x -5 and pos.x < $Viewport/Zona_de_interfaz/xd/Zona_de_amuletos/Specials1.global_position.x + diferencia.x +10
			else:
				dentro_x = pos.x > $Viewport/Zona_de_interfaz/xd/Zona_de_amuletos/Specials1.global_position.x - diferencia.x - 5 and pos.x < $Viewport/Zona_de_interfaz/xd/Zona_de_amuletos/Specials1.global_position.x + diferencia.x +10
