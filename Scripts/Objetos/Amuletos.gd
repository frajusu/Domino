...
var valores_diccionario = {
	...
	"Crystal Dice" : ["Mimics one random charm at the start of a level (temporary). \n(", "null"],
...
func _physics_process(delta):
		...
		if !gratis:
			...
			if costo_label: costo_label.bbcode_text  = "[center]%s[/center]" % Text.parsear_colores_bbcode1(Text.parsear_colores_bbcode("<#b1911a>0"))  + "[color=#b1911a]" + Global.prefix_plata
