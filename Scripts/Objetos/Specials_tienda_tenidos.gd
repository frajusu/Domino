...
func _physics_process(delta):
	...
	if get_parent().get_parent().get_parent().get_parent().get_parent().get_parent().baraja_activa == "baraja_especial":
...
func update_focus():
	if get_parent().get_parent().get_parent().get_parent().get_parent().get_parent().estacion_actual == "tienda" and get_parent().get_parent().get_parent().get_parent().get_parent().get_parent().baraja_activa == "baraja_especial":
		var hovered = []
		for d in get_tree().get_nodes_in_group("dominos"):
			if d.get_parent().name != "Baraja_specials":
