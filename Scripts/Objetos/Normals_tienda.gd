...
func _physics_process(delta):
	...
	var costo_label  = get_node("Descripcion/MarginContainer/Costo/Label")
	costo_label.bbcode_enabled  = true
	
	var precio_str = yo["plata"]
	...
	if get_parent().get_parent().get_parent().get_parent().baraja_activa == "baraja" or get_parent().get_parent().get_parent().get_parent().baraja_activa == "baraja_especial":
...
func update_focus():
	if get_parent().get_parent().get_parent().get_parent().estacion_actual == "tienda" and get_parent().get_parent().get_parent().get_parent().baraja_activa != "baraja_amuletos" and get_parent().get_parent().get_parent().get_parent().baraja_activa != "usando_amuleto":
		var hovered = []
		...
		for d in get_tree().get_nodes_in_group("dominos"):
			if !get_parent().dragging and !get_parent().get_parent().get_node("Baraja_stamps").dragging and !get_parent().get_parent().get_node("Baraja_specials").dragging:
				if d == leftmost:
