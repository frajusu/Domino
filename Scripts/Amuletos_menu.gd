...
func actualizar_sombra():
	...
	if get_parent().dragging != self:
		if    int($Descripcion.global_position.y) > int(get_parent().get_parent().get_parent().get_parent().rect_global_position.y+get_parent().get_parent().get_parent().get_parent().rect_size.y-diferenciaa):
			$Descripcion.global_position.y = int(get_parent().get_parent().get_parent().get_parent().rect_global_position.y+get_parent().get_parent().get_parent().get_parent().rect_size.y-diferenciaa)
		elif  int($Descripcion.global_position.y) < int(get_parent().get_parent().get_parent().get_parent().rect_global_position.y+get_parent().get_parent().get_parent().get_parent().rect_size.y-diferenciaa):
			$Descripcion.global_position.y += 1
...
func update_focus():
	if get_tree().root.get_node("Game").estacion_actual == "nivel" or get_tree().root.get_node("Game").estacion_actual == "tienda":
		var hovered = []
